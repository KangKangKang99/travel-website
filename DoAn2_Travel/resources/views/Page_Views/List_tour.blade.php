...
@section('content')
    ...
    @if($object_status==1)
    <div class="bradcam_area bradcam_bg_2" style="background-image: url({{asset('uploads/destinations/banner/'.$object->object_banner)}});">
    @elseif($object_status==2)
    <div class="bradcam_area bradcam_bg_2" style="background-image: url({{asset('uploads/typetours/banner/'.$object->object_banner)}});">
    @else
            <div class="bradcam_area bradcam_bg_2" style="background-image: url({{asset('Pages/img/banner/banner3.jpg')}});">
    @endif
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                        ...
                        <div class="filter_inner">
                            <div class="row">
                                ...
                                <div class="col-5" style="color: #ff5e13; margin-top: 5px">
                                    <div class="row" >
                                        <i class="fa fa-tag" style="margin-bottom: 10px;padding-left: 10px"> {{$tour[0]->destination_name_EN}}</i>
                                        <i class="fa fa-tag" style="margin-bottom: 10px;padding-left: 10px"> {{$tour[0]->destination_name_VI}}</i>
                                    </div>
                                    <div class="row">
                                        <i class="fa fa-tag"style="margin-bottom: 10px;padding-left: 10px"> {{$tour[0]->typetour_name_EN}}</i>
                                        <i class="fa fa-tag"style="margin-bottom: 10px;padding-left: 10px"> {{$tour[0]->typetour_name_VI}} </i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="item_box col-lg-4 col-sm-6" price="{{$Tour->tour_price}}" name="{{$Tour->tour_name_VI}}">
                                <div class="single_place">
                                    <div class="thumb">
                                        ...
                                        <a href=""  class="prise tour-price">${{$Tour->tour_price}}</a>
                                    </div>
                                    <div class="place_info">
                                        <a class="tour-name"  href="{{URL::to('/tour/'.$Tour->tour_name_EN)}}"><h3>{{$Tour->tour_name_VI}}</h3></a>
                                        <div class="row">
