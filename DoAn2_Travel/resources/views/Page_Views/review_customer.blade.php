                        ...
                        <div id="form_to_book" >
                            <div class="contact_join" >
                                <h3>{{__('CUSTOMER INFOR')}}</h3>
                                    ...
                                    <div class="mt-10">
                                        <input disabled type="text" name="booking_customer_name" value="{{$booking->booking_customer_name}}"
                                               onfocus="this.placeholder = ''" onblur="this.placeholder = '{{__('Full Name')}}'" required
                                               class="single-input">
                                    </div>
                                    <div class="mt-10">
                                        <input disabled type="email" name="booking_customer_email" value="{{$booking->booking_customer_email}}"
                                               onfocus="this.placeholder = ''" onblur="this.placeholder = '{{__('Email address')}}'" required
                                               class="single-input">
                                    </div>
                                    <div class="input-group-icon mt-10">
                                        <div class="icon"><i class="fa fa-thumb-tack" aria-hidden="true"></i></div>
                                        <input disabled type="text" name="booking_customer_address" value="{{$booking->booking_customer_address}}" onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = '{{__('Address')}}'" required class="single-input">
                                    </div>
                                    <div class="input-group-icon mt-10">
                                        <div class="icon"><i class="fa fa-globe" aria-hidden="true"></i></div>
                                        <input disabled type="text" name="booking_customer_address" value="{{$booking->booking_customer_nationality}}" onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = '{{__('Address')}}'" required class="single-input">
                                    </div>
                                    <div class="input-group-icon mt-10">
                                        <div class="icon"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                        <input disabled type="text" name="booking_customer_address" value="{{$booking->booking_customer_phone_number}}" onfocus="this.placeholder = ''"
                                               onblur="this.placeholder = '{{__('Address')}}'" required class="single-input">
                                    </div>
                                    <div class="mt-10">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <input disabled style="display: block;
                                                          ...
                                                          padding: 0 20px;
                                                          resize: none;"
                                                       class="form-control" type="date" value="{{$booking->booking_date}}" id="example-datetime-local-input"
                                                       name="booking_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-10">
                                <textarea disabled class="single-textarea" data-value="{{$booking->booking_customer_message}}" onfocus="this.placeholder = ''"
                                          onblur="this.placeholder = '{{__('Message')}}'" name="booking_customer_message" ></textarea>
                                    </div>
                                    <div class="mt-10" style="margin-top:20px;">
                                        <div class="submit_btn">
                                            <button disabled class="boxed-btn4" type="submit">{{__('REVIEW')}}</button>
                                        </div>
                                    </div>
                            </div>
                                    ...
                                    <div class="cost_from">
                                        <div class="sample-text">
                                            ...
                                            <div class="how-it-work-item">
                                                <form id="form-submit" action="{{URL::to('save-customer-review')}}" method="post">
                                                    {{csrf_field()}}
                                                    ...
                                                    <ul>
                                                        <li class="row">
                                                            ...
                                                            <p>{{__('Comment')}}</p>
                                                            <textarea required  class="single-textarea" placeholder="{{__('Message')}}...."  onfocus="this.placeholder = ''"
                                                                       onblur="this.placeholder = '{{__('message')}}'" name="review_comment" ></textarea>
                                                        </li>
                                                        <li class="row">
                                                            <div class="work-number">1</div>
                                                            <p >{{__('Rating')}}</p>
                                                            <div   class="row" style=" margin: -6px 0px 0px 30px; font-size: 30px;color: red;cursor: pointer " >
                                                                <div >
