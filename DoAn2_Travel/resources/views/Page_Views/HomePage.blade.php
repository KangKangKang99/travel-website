            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="more_place_btn text-center">
                        <a class="boxed-btn4" href="/destination">{{__('More Destinations')}}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="thumbnail">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section_title text-center mb_70">
                            ...
                            <p>{{__('Choose your trip with SEATRIPS in our categories, we have the best and most suitable options for you, from romantic and dreamy....')}}</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="more_place_btn text-center">
                            <a class="boxed-btn4" href="/type-of-tour">{{__('More Type of Tour')}}</a>
                        </div>
                    </div>
                </div>
            </div>
