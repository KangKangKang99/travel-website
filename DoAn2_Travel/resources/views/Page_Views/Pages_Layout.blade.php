...
<head>
    ...
    <title>SEATRIPS</title>
    <link rel="icon" type="image/png" size="20x10" href="{{asset('Pages/img/logo3.png')}}">
    ...
    <link rel="stylesheet" href="{{asset('https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.5.0/css/flag-icon.min.css')}}">
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="" href="{{URL::to('/destination')}}">{{__('DESTINATIONS')}}</a></li>
                                        <li><a class="" href="{{URL::to('type-of-tour')}}">{{__('TYPE OF VACATION')}}</a></li>
                                        <li><a href="">{{__('BLOG')}} <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="{{URL::to('/blog')}}">{{__('NEWS')}}</a></li>
                                                <li><a href="{{URL::to('/gallery')}}">{{__('GALLERY')}}</a></li>
                                                <li><a href="{{URL::to('/trip-guide')}}">{{__('TRIPS GUIDE')}}</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{URL::to('/about')}}">{{__('ABOUT')}}</a></li>
                                        <li>
                                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                if($lang_status!="en"){
                                                ?>
                                                <i class="flag-icon flag-icon-vn" style="font-size: 20px"></i>
                                                <?php
                                                }else {
                                                ?>
                                                <i class="flag-icon flag-icon-us" style="font-size: 20px"></i>
                                                <?php
                                                }
                                                ?>
                                            </a>
                                            <ul class="submenu">
                                                <li><a class="dropdown-item" href="{{route('language',['language'=>'en'])}}"><i class="flag-icon flag-icon-us" style="font-size: 20px"></i> {{__('English')}}</a></li>
                                                <li><a class="dropdown-item" href="{{route('language',['language'=>'vi'])}}"><i class="flag-icon flag-icon-vn" style="font-size: 20px"></i> {{__("Vietnamese")}}</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </nav>
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="social_wrap d-flex align-items-center justify-content-end">
                                <div class="number">
                                    <p> <li><a href="{{URL::to('/contact-us')}}">{{__('CONTACT')}}</a></li></p>
                                </div>
                                <div class="social_links d-none d-xl-block">
                                    <ul>

                                        <li><a target="_blank" href="https://www.instagram.com/blanker00102313/?hl=vi"> <i class="fa fa-instagram"></i> </a></li>
                                        <li><a target="_blank" href="https://www.facebook.com/%C4%90%E1%BB%93-%C3%A1n-Tr%C3%A2y-V%E1%BB%93-107910384441177"> <i class="fa fa-facebook"></i> </a></li>
...
<footer class="footer">
    <div class="footer_top">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4 ">
                    <div class="footer_widget">
                        ...
                        <p>1ST Floor, No 1 Dai Co Viet Street,<br> Bach Khoa District <br> Ha Noi, Viet Nam <br>
                            <a href="#">+84 0972710002</a> <br>
                            <a href="#">kietjkd@gmail.com</a>
                        </p>
                        <div class="socail_links">
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/%C4%90%E1%BB%93-%C3%A1n-Tr%C3%A2y-V%E1%BB%93-107910384441177" target="_blank">
                ...
                <div class="col-xl-2 col-md-6 col-lg-2">
                    <div class="footer_widget">
                        ...
                        <ul class="links">
                            ...
                            <li><a href="#"> {{__('Term and conditions')}}</a></li>
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul class="links double_links">
                            <li><a href="{{URL::to('destination/Vietnam')}}">VietNam</a></li>
                            <li><a href="{{URL::to('destination/Indonesia')}}">Indonesia</a></li>
                            <li><a href="{{URL::to('destination/ThaiLand')}}">ThaiLand</a></li>
                            <li><a href="{{URL::to('destination/Cambodia')}}">Cambodia</a></li>
                            <li><a href="{{URL::to('destination/Laos')}}">Laos</a></li>
                            <li><a href="{{URL::to('destination/Philippines')}}">Philippines</a></li>
                            <li><a href="{{URL::to('destination/Myanmar')}}">Myanmar</a></li>
                            <li><a href="{{URL::to('destination/Malaysia')}}">Malaysia</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
        ...
        <div class="container">
            <a id="back-to-top" href="#" class="btn btn-light btn-lg back-to-top" role="button" style=" background-color: #FF4A52; border: none; position: fixed;bottom: 25px;right: 25px;display: none;"><i style="color: white" class="fa fa-chevron-up" ></i></a>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <p class="copy_right text-center">
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <a href="https://travel.vietnam" target="_blank">Asia Like Trips </a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="serch_form">
                <form action="{{URL::to('search-2')}}" method="get">
                    <input name="search_content" type="text" placeholder="{{__('Name or Destination or Typetour')}}" >
...
<!-- link that opens popup -->
    ...
    {{--<script src="{{asset('https://static.codepen.io/assets/common/stopExecutionOnTimeout-de7e2ef6bfefd24b79a3f68b414b87b8db5b08439cac3f1012092b2290c719cd.js')}}"></script>--}}
