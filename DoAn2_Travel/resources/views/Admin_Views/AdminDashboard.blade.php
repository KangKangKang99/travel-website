    ...
    <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body" style="margin-bottom: 30px">
                        <div class="d-md-flex align-items-center">
                            ...
                            <div class="ml-auto d-flex no-block align-items-center">
                                <ul class="list-inline font-12 dl m-r-15 m-b-0">
                                    <li style="color: red!important;" class="list-inline-item text-info"><i class="fa fa-circle"></i> profit</li>
                                </ul>
                                <div class="dl">
                        ...
                        <div class="row">
                            <!-- column -->
                            <div class="col-lg-4">
                                <h1 class="m-b-0 m-t-30">$ {{number_format($total_revenue,2)}}</h1>
                                <h6 class="font-light text-muted">{{__("Revenue current year")}}</h6>
                                <h3 class="m-t-30 m-b-0">$ {{number_format($highest_month,2)}}</h3>
                                <h6 class="font-light text-muted">{{__('Highest Monthly Revenue')}}</h6>
                                <a class="btn btn-info m-t-20 p-15 p-l-25 p-r-25 m-b-20" href="javascript:void(0)">{{__('Revenue of '). Session::get('year_revenue')}}</a>
                            </div>
                            <!-- Cột thống kê  -->
                        ...
                        <div class="row m-b-0">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span>{{__('First Quarter')}}</span>
                                        <h3 class="font-medium m-b-0">$ {{number_format($first_part,2)}}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span>{{__('Second Quarter')}}</span>
                                        <h3 class="font-medium m-b-0">$ {{number_format($second_part,2)}}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span>{{__('Third Quarter')}}</span>
                                        <h3 class="font-medium m-b-0">$ {{number_format($third_part,2)}}</h3></div>
                                </div>
                            </div>
                            <!-- col -->
                            <!-- col -->
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span>{{__('Fourth Quarter')}}</span>
                                        <h3 class="font-medium m-b-0">$ {{number_format($fourth_part,2)}}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card card-hover">
                    <div class="card-body">
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">{{__('Booking statistics')}}</h4>
                        ...
                        <div class="row m-t-40">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span>{{__('Request of visitors')}}</span>
                                <ul class="list-style-none">
                                    <li class="m-t-20"><i style="color: #d70206" class="fas fa-circle m-r-5 font-12">
                                        </i> {{__('Contracted booking')}} <span class="float-right">{{$per_contracted_booking}}</span></li>
                                    <li class="m-t-20"><i style="color: #f05b4f" class="fas fa-circle m-r-5  font-12">
                                        </i> {{__('Confirmed')}} <span class="float-right">{{$per_confirmed_booking}}</span></li>
                                    <li class="m-t-20"><i style="color: #f4c63d" class="fas fa-circle m-r-5  font-12">
                                        </i> {{__('Unconfirmed')}} <span class="float-right">{{$per_unconfirmed_booking}}</span></li>
                                    <li class="m-t-20"><i style="color: #d17905" class="fas fa-circle m-r-5  font-12">
                                        </i> {{__('Canceled')}} <span class="float-right">{{$per_canceled_booking}}</span></li>
                                </ul>
                            </div>
                        </div>
                        <!-- column -->
                        ...
                        <div class="p-t-20 text-center">
                            ...
                            <div class="row m-t-30 m-b-20">
                                ...
                                <div class="col-3 border-right text-center">
                                    <h3 class="m-b-0 font-medium">{{$per_signed_contract}}</h3>{{__('Signed')}}</div>
                                <!-- column -->
                                <div class="col-3 border-right text-center">
                                    <h3 class="m-b-0 font-medium">{{$per_ongoing_contract}}</h3>{{__('On going')}}</div>
                                <!-- column -->
                                <div class="col-3 text-center">
                                    <h3 class="m-b-0 font-medium">{{$per_completed_contract}}</h3>{{__('Completed')}}</div>
                                <div class="col-3 text-center">
                                    <h3 class="m-b-0 font-medium">{{$per_canceled_contract}}</h3>{{__('Canceled')}}</div>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-md-flex align-items-center">
                            <div>
                                <h4 class="card-title">{{__('List Staffs')}}</h4>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table no-wrap v-middle">
                                <thead>
                                <tr class="border-0">
                                    <th class="border-0">{{__('Staffs')}}</th>
                                    <th class="border-0">{{__('Position')}}</th>
                                    <th class="border-0">{{__('Phone number')}}</th>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{__('Comments and Rates')}}</h4>
                    </div>
                    <div class="comment-widgets scrollable" style="height:560px;">
                        <!-- Comment Row -->
                        @foreach($review as $review)
                            <div class="d-flex flex-row comment-row m-t-0">
                                <div class="p-2"><img src="{{'Admins/img/users/1.jpg'}}" alt="user" width="50" class="rounded-circle"></div>
                                <div class="comment-text w-100">
                                    ...
                                    @if($review->review_rating==1)
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"> {{date('d-m-Y', strtotime($review->created_at))}}</span> <span class="label label-rounded label-danger">Very Bad</span>
                                    ...
                                    @elseif($review->review_rating==2)
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"> {{date('d-m-Y', strtotime($review->created_at))}}</span> <span class="label label-rounded label-danger">Bad</span>
                                    ...
                                    @elseif($review->review_rating==3)
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"> {{date('d-m-Y', strtotime($review->created_at))}}</span> <span class="label label-rounded label-warning">Medium</span>
                                    ...
                                    @elseif($review->review_rating==4)
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"> {{date('d-m-Y', strtotime($review->created_at))}}</span> <span class="label label-rounded label-success">Good</span>
                                    ...
                                    @else
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"> {{date('d-m-Y', strtotime($review->created_at))}}</span> <span class="label label-rounded label-success">Very Good</span>
