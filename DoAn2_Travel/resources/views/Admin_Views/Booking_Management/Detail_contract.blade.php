                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                   <a href=""> <label for="" class="control-label col-form-label">{{__("Customer")}}</label></a>
                                    <input disabled type="text" class="form-control" id="" value="{{$booking->customer_name}}" name="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" id="" value="{{$booking->customer_phone_domain}} {{$booking->customer_phone_number}}" name="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <input disabled   name="contract_total_price" id="only_numb" class="form-control" value="$ {{$contract->contract_total_price}} ">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
