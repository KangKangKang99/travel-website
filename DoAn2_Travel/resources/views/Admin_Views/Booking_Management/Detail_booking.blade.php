                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="com1" placeholder="{{$booking->booking_code}}" name="booking_code" disabled>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <a href="{{URL::to('')}}"><label for="com1" class="control-label col-form-label">{{__("Tour booking")}}</label></a>
                                        <?php $lang_status = Session::get('language');
                                        if($lang_status!="en"){
                                        ?>
                                            <input type="text" class="form-control" id="com1" placeholder="{{$booking->tour_name_VI}}" name="tour_name" disabled>
                                        <?php
                                        }else {
                                        ?>
                                            <input type="text" class="form-control" id="com11" placeholder="{{$booking->tour_name_EN}}" name="tour_name" disabled>
                                        <?php
                                        }
                                        ?>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="com1" value="{{$booking->booking_customer_name}}" name="booking_customer_name" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Customer Email")}}</label>
                                    <input type="text" class="form-control" id="com1" value="{{$booking->booking_customer_email}}" name="booking_customer_email" >
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="phone"  value=" {{$booking->booking_customer_phone_number}}" name="booking_customer_phone_number" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <input type="text" class="form-control"  value=" {{$booking->booking_customer_address}}" name="booking_customer_address" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="com1" value="{{$booking->booking_customer_nationality}}" name="booking_customer_nationality" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Booking date")}}</label>
                                    <input type="date" class="form-control input" id="com1" value="{{$booking->booking_date}}" name="booking_date" >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Request date")}}</label>
                                    <input type="text" class="form-control input" id="com1" value="{{$booking->created_at}}" name="" disabled>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Number Adult")}}</label>
                                    <input min="1" type="number" class="form-control input"  value="{{$booking->booking_customer_adult}}" name="booking_customer_adult" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Number Child")}}</label>
                                    <input min="0" type="number" class="form-control input"  value="{{$booking->booking_customer_child}}" name="booking_customer_child" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Number Ifant")}}</label>
                                    <input min="0" type="number" class="form-control input"  value="{{$booking->booking_customer_ifant}}" name="booking_customer_ifant" >
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="com1" class="control-label col-form-label">{{__("Booking message")}}</label>
                                    <textarea  class="form-control" id="exampleTextarea12" rows="4" data-value="{{$booking->booking_customer_message}}" placeholder="{{$booking->booking_customer_message}}" name="booking_customer_message"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="action-form">
                            <div class="form-group m-b-0 text-center">
                                <div></div>
                                <button type="submit" class="btn-enable btn btn-info waves-effect waves-light">{{__('Save')}}</button>
                                <a href="{{URL::to('list-booking/'.$booking->booking_status)}}" class="btn btn-dark waves-effect waves-light">{{__('Cancel')}}</a>
                            </div>
                        </div>
                    </div>
                </form>
