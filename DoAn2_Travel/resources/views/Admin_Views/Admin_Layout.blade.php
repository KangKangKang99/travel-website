...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('Pages/img/logo_03.png')}}">
    <title>SEATRIPS Admin</title>
    <!-- Custom CSS -->
                ...
                <ul class="navbar-nav float-right">
                    ...
                    ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right  animated bounceInDown" aria-labelledby="navbarDropdown2">
                            <a class="dropdown-item" href="{{route('language',['language'=>'en'])}}"><i class="flag-icon flag-icon-us"></i> {{__('English')}}</a>
                            <a class="dropdown-item" href="{{route('language',['language'=>'vi'])}}"><i class="flag-icon flag-icon-vn"></i> {{__("Vietnam")}}</a>
                        </div>
                    </li>
                    <!-- ============================================================== -->
                    <!-- Comment -->
                ...
                <ul id="sidebarnav">
                    ...
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-nature-people"></i><span class="hide-menu">{{__('STAFF')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item">
                                <a href="{{URL::to('add-staff')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Change staff')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('list-staff/2')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Sales department')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('list-staff/3')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Customer care department')}} </span></a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{URL::to('list-staff/4')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Technical department')}} </span></a>
                            </li>
                        </ul>
                    </li>
                    {{--end staff manager--}}
        ...
        <footer class="footer text-center">
            <div class="col-xl-12">
                <p class="copy_right text-center">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <a href="http://127.0.0.1:8000/" target="_blank">Asia Like Trips </a>
                </p>
            </div>
        </footer>
        <!-- ============================================================== -->
