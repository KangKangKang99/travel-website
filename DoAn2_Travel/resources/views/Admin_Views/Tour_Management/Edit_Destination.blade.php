                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <img class="hover-img" src="{{URL::to('uploads/destinations/thumb/'.$edit_Dest->destination_thumb)}}" height="80" width="80">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                   <div class="row">
                                       ...
                                       <div class="col-4">
                                           <img class="hover-img" src="{{URL::to('uploads/destinations/banner/'.$edit_Dest->destination_banner)}}" height="80" width="80">
