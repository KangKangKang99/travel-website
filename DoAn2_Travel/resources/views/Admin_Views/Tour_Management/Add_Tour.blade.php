                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="com1" placeholder="{{__("Name here")}}" name="tour_name_VI" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="emp1" class="control-label col-form-label">{{__("Name in English")}}</label>
                                    <input type="text" class="form-control" id="emp1" placeholder="{{__("Name here")}}" name="tour_name_EN" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin-left:1px ">
                                            ...
                                            <input onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"  type="text" class="form-control col-11 " id="com9" placeholder="{{__("Cost here")}}" name="tour_price" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea2" rows="4" placeholder="{{__('Desc Here')}}" name="tour_desc_VI" required></textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="control-label col-form-label">{{__('Desc in English')}}</label>
                                    <textarea class="form-control" id="exampleTextarea2" rows="4" placeholder="{{__('Desc Here')}}" name="tour_desc_EN" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea2" rows="4" placeholder="{{__('Overview Here')}}" name="tour_overview_VI" required></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="control-label col-form-label">{{__('Overview in English')}}</label>
                                    <textarea class="form-control" id="exampleTextarea2" rows="4" placeholder="{{__('Overview Here')}}" name="tour_overview_EN" required></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control"  accept="image/x-png,image/gif,image/jpeg" name="tour_img1" required>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label for="">{{__('Image')}} 2</label>
                                    <input type="file" class="form-control"  accept="image/x-png,image/gif,image/jpeg" name="tour_img2" required>
                                </div>
                            </div><div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label for="">{{__('Image')}} 3</label>
                                    <input type="file" class="form-control"  accept="image/x-png,image/gif,image/jpeg" name="tour_img3" required>
                                </div>
                            </div><div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label for="">{{__('Image')}} 4</label>
                                    <input type="file" class="form-control"  accept="image/x-png,image/gif,image/jpeg" name="tour_img4" required>
                                </div>
                            </div><div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label for="">{{__('Image')}} 5</label>
                                    <input type="file" class="form-control"  accept="image/x-png,image/gif,image/jpeg" name="tour_img5" required>
                                </div>
                            </div><div class="col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label for="">{{__('Image')}} 6</label>
                                    <input type="file" class="form-control"  accept="image/x-png,image/gif,image/jpeg" name="tour_img6" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <label for="">{{__('Duration')}}</label>
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <input min="1" type="number" class="form-control col-12 " id="emp5" placeholder="" name="tour_day" required>
                                        </div>
                                        <p style="padding:8px 8px 0px 0px;">{{__("Days")}}</p>
                                        <div class="col-lg-3 col-sm-6">
                                            <input min="1" type="number" class="form-control col-12 " id="emp6" placeholder="" name="tour_night" required>
                                        </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="row ">
                                    <div class="col-12">
                                        <input type="text" class="form-control col-12 " id="emp7" placeholder="" name="tour_arrival" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="row ">
                                    <div class="col-12">
                                        <input type="text" class="form-control col-12 " id="emp8" placeholder="" name="tour_departure" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="control-group" id="fields">
                                            <div class="entry input-group ">
                                                <textarea class="form-control" name="tour_sche"  placeholder="{{__('Tour schedule')}}" required ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="control-group" id="fields">
                                            <div class="controls">
                                                    <div class="entry input-group ">
                                                        ...
                                                        <textarea class="form-control clone col-8" name="tour_day_1" placeholder="Day 1" required></textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="control-group" id="fields">
                                            <div class="entry input-group ">
                                                <textarea class="form-control" name="tour_map"  placeholder="{{__('url google maps here')}}" required ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <textarea class="form-control" id="exampleTextarea2" rows="8" placeholder="{{__('Included')}}" name="tour_service_in" required></textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <textarea class="form-control" id="exampleTextarea2" rows="8" placeholder="{{__('Excluded')}}" name="tour_service_ex" required></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="action-form">
                            <div class="form-group m-b-0 text-center">
                                ...
                                <a href="{{URL::to('/add-tour')}}" class="btn btn-dark waves-effect waves-light">{{__('Cancel')}}</a>
                            </div>
                        </div>
                    </div>
                </form>
